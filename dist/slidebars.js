...
(function (root, factory) {
	if (typeof define === "function" && define.amd) {
		...
		root.slidebars = factory(root.jQuery);
	}
}(this, function ($) {
	var Slidebars = function (options) {
		var settings = $.extend({
	...
	// TODO: better way to define jQuery function?
	// What about return the slidebar instance?

	$.fn.slidebars = function (options) {
		return Slidebars(options);
	};

	$.slidebars = $.fn.slidebars;
